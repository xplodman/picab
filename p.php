            ...
            <div class="col-sm-8">
                <font face="myFirstFont">
                    <div class="title-action">
                        <button class="btn btn-primary " type="button" data-toggle="modal" data-target="#adduser2"><i class="fa fa-plus"></i> Add a user</button>
                    </div>
                </font>
            </div>
        </div>
        <div class="modal inmodal" id="adduser2" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" action="php/insertuser.php" class="form-horizontal">
                            ...
                            <div class="form-group"><label class="col-sm-2 control-label">Job</label>
                                <div class="col-sm-10"><div class="input-group"><select id="joblist" class="chosen-select form-control" name="jobid">
                                            <option></option>
