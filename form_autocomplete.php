...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.7.1/form_autocomplete.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2017 11:39:02 GMT -->
<head>
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li  class="active"><a href="form_autocomplete.html">Autocomplete</a></li>
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td>JSON object</td>
                                    <td>false</td>
                                    <td>Adds an item to the end of the list, for example "New Entry". This could be used, for example, to pop a dialog when an item is not found in the list of data. Example: <a href="https://my.cl.ly/content/2u170I1q1G3A">http://cl.ly/image/2u170I1q1G3A/addItem.png</a></td>
                                </tr></tbody>
                            </table>
                        </div>
                    </div>
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.7.1/form_autocomplete.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 25 Jul 2017 11:39:03 GMT -->
</html>
