        ...
        <div class="sidebar-collapse" >
            <font face="myFirstFont">
                <ul class="nav metismenu"  id="side-menu">
                    ...
                    <li class="active">
                        <a href="Suppliers.html"><i class="fa fa-microchip"></i> <span class="nav-label">Category</span></a>
                    </li>
                </ul>
            </font>
        </div>
            ...
            <div class="col-sm-8">
                <font face="myFirstFont">
                    <div class="title-action">
                        <button class="btn btn-primary " type="button" data-toggle="modal" data-target="#addcat"><i class="fa fa-plus"></i> Add a category</button>
                    </div>
                </font>
            </div>
        </div>
...
From hardware
  ...
  Left Join user_has_hardware On user_has_hardware.hardwareid =
    hardware.hardwareid
Where  prosecution.prosecutionid = $ids2[$z] AND category.categoryid = $ids[$y]") or die(mysqli_error($con));
        $row3 = mysqli_fetch_row($result3);
        $row3 = implode("", $row3);
        $results.= "' , '".$row3;
